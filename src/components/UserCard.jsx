    ...
    return (
        <article className="user">
            ...
            <ul className="user__list">
                ...
                <li className="user__item"><span className="user__span">Birthday</span> <div className="user__item-container"><i className=" user__gift fa-solid fa-gift"></i>{user.birthday}</div></li>
            </ul>
